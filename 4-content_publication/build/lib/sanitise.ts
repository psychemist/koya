 ...
 *
 * Assemble a log line from a request body once, and a credential ends up in a
 * screenshot in a demo video. This runs on everything before it is written
 * anywhere — the events table, stdout, a Discord payload.
 */
 ...
 * inside text that looks innocent to a reviewer reading the same page.
 */
