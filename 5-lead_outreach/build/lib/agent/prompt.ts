...
export function buildSystemPrompt(run: RunRow): string {
  return [
    ...
    '3. For candidates worth reading, call scrape_company_site.',
    '4. Invoke lead-qualification, then call save_lead with evidence.',
    '5. For qualified leads, invoke outbound-copywriting, then call save_outreach.',
    '6. Invoke lead-list-quality, then call finish_run.',
    '',
